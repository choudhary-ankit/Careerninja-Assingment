...
import Style from './GameboardAi.module.css'
...
export default class GameboardAi extends Component {
    constructor(props){
        super(props)
        this.state={
            first_move:'',
    ...
    aiTurn=()=>{
        ...
        for(let i=0; i<100; i++){ 
            ...
            if (this.state.boxes[x][y]===undefined){
                newboxes[x][y]=this.state.players
                this.setState({
                    boxes:newboxes,
                    players:1-this.state.players,
                })
                                ...
                                {   
                                    ...
                                    :
                                        <div className={this.state.first_input==='x'? Style.o_turn : Style.x_turn}>
                                            <p>{`Wait For ${this.state.second_move} Move`}</p>
                                        </div>
                            ...
                            <div>
                                <Modal
                                    ...
                                    <div className={Style.modal_body}>
                                        {
                                            this.state.draw===''?
                                                <div className={Style.modal_frame}>
                                                    {
                                                        ...
                                                        :
                                                            <div className={Style.modal_arrng}>
                                                                <p>{`you lost the Game ${this.state.first_move}`}</p>
                                                                <button onClick={this.modalClose}>continue</button>
                                                            </div>
                                                    }
                                                </div>
                                            :
                                                <div className={Style.modal_arrng}>
                                                    <p>{this.state.draw}</p>
                                                    <button onClick={this.modalClose}>Restart</button>
                                                </div>
                                        }
